...
|----------|-------------|---------|
| `DATABASE_URL` | PostgreSQL connection URL | Auto-generated by Render |
| `DB_USERNAME` | Database username | `finance_tracker_user` |
...
| `ADMIN_PASSWORD` | Admin password | Generate secure password |
| `SPRING_PROFILES_ACTIVE` | Spring profile | `render` |
